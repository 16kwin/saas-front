// DocumentsTab.jsx — read-only версия для Zadel
                ...
                {isLoading ? (
                  ...
                  <>
                    {Array.from({ length: totalRows }).map((_, index) => {
                      ...
                      return (
                        <div key={doc.uid} style={{ height: ROW_HEIGHT, display: 'flex', alignItems: 'center', backgroundColor: '#FFFFFF', position: 'relative', boxSizing: 'border-box', borderTop: isFirst ? 'none' : '0.5px solid #E5ECF5', borderBottom: isLast ? 'none' : '0.5px solid #E5ECF5' }}>
